...
# TODO:
# * Adapt code and license
# * Fix some minor pygame stuff
#  * Resolution / Fullscreen / Windowed
# * Make twiddling elements stop after a while (eats cpu like otherwise)
# * Screenshot functionality would be nice
...
if __name__=="__main__":
    ...
    resolution = dictArgs.get("screensize",(1900,1190))
    resolution = [1900,1190]
